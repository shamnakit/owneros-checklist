// =============================
// 6) pages/admin/analytics/interest.tsx
// =============================
...
try {
setLoading(true);
const res = await fetch(`/api/analytics/interest?date_from=-30d&breakdown=plan`);
...
{loading ? (
<div className="text-neutral-400">Loading interest…</div>
) : (
